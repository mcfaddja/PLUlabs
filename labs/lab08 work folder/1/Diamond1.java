...
public class Diamond1 extends Frame {
	int height = 300;
	int width = 400;
	int start = 1;
	int start1 = 1;
	...
	public Diamond1( int spaceX, int spaceY,  int dNum , String write  ) {
		super( "Diamond" ) ;
...
// Instantiate a frame
	public static void main( String args[] )
	{
		...
		Diamond1  theFrame ;
		theFrame = new Diamond1( xSpacing, ySpacing, diamondNumber, whichCharacter ) ;
	}
